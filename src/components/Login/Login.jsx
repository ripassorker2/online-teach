    ...
    <div>
      <div className="my-11">
        <div className="flex justify-center ">
          <div className="flex bg-white rounded-lg py-6 text-lg items-center w-full max-w-md px-6 mx-auto shadow-xl lg:w-2/6">
                ...
                <form onSubmit={handleSubmitInfo}>
                  ...
                  <div className="mt-6">
                    <div className="flex justify-between mb-2">
                      ...
                      <Link
                        to={"/resetPassword"}
                        className="text-base text-blue-500 hover:text-blue-500 hover:underline"
                      >
                        Forgot password?
                      </Link>
                    </div>
