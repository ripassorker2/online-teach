  ...
  return (
    <div className=" grid grid-cols-4  mx-auto gap-x-8 ">
      <div className="text-center col-span-3  md:my-24 my-11 ">
        ...
        <div className="grid lg:grid-cols-3 md:grid-cols-2  gap-6 sm:w-11/12 m-auto ">
          {courses.map((course) => (
      ...
      <div className="text-lg py-6 text-center bg-gray-800 ">
        <h1 className="text-3xl  border-b-2 border-white pb-4 text-white">Our courses</h1>
        {courses.map((course) => (
          <ul className=" text-blue-700 underline my-3" key={course.id}>
